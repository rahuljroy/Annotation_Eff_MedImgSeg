...
# wandb.init(project='KD_EFFNet_spine', 
#         name='EffNet_ce_'+str(0)+'_'+str(0)+'_'+str(args.n_epochs),
#         reinit=True,
#         config = args
# )
...
#     wandb.init(project='KD_EFFNet_spine', 
#             name='EffNet_pi_'+str(lamb1)+'_'+str(0)+'_'+str(args.n_epochs),
#             reinit=True,
#             config = args
#     )
...
for lamb1 in lambda1:
    for lamb2 in lambda2:
        ...
        wandb.init(project='KD_EFFNet_spine', 
                name='EffNet_pa_'+str(lamb1)+'_'+str(lamb2)+'_'+str(args.n_epochs),
                reinit=True,
                config = args
        )
