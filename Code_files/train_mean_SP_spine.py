...
from dataset import Mean_Prior_MSD, get_train_val_loader, Mean_Prior_Spine
...
dataset = Mean_Prior_Spine(root = root_dir, imgdir = imgdir, labeldir = labeldir, labeldir_left = labeldir_left, labeldir_right = labeldir_right, device = torch.device("cuda:0"))
